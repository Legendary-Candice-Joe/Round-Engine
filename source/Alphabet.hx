...
class Alphabet extends FlxSpriteGroup
{
	...
	public var daGlow:AlphabetGlowing;

	public var finishedText:Bool = false;
	public var typed:Bool = false;
																																					// |
	public var typingSpeed:Float = 0.05;																											// V  nvm unsuesd
	public function new(x:Float, y:Float, text:String = "", ?bold:Bool = false, typed:Bool = false, ?typingSpeed:Float = 0.05, ?textSize:Float = 1, Glow:Bool = false)
	{
		super(x, y);
		
		if (Glow){
			daGlow = new AlphabetGlowing(x - 25, y - 25, text, bold, typed, typingSpeed, textSize);
			add(daGlow);
		} else {
