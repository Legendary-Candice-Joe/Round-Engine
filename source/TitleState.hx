...
class TitleState extends MusicBeatState
{
	...
	var credTextShit:AlphabetGlowing;
	...
	override public function create():Void
	{
		...
		FlxG.save.bind('RoundEngine', 'Isaac Mod Studios');
		
		Settings.Init();
		FlxG.fullscreen = Settings.Get("Start Fullscreen");
		FlxG.updateFramerate = Settings.Get('FPS Cap');
		FlxG.drawFramerate = Settings.Get('FPS Cap');

		FlxG.sound.muted = false;
		FlxG.sound.volume = Settings.Get('Start Volume') / 100;
	...
	function startIntro()
	{
		...
		credTextShit = new AlphabetGlowing(0, 0, "ninjamuffin99\nPhantomArcade\nkawaisprite\nevilsk8er", true);
	...
	function createCoolText(textArray:Array<String>)
	{
		...
		{
			var money:AlphabetGlowing = new AlphabetGlowing(0, 0, textArray[i], true, false);
	...
	{
		var coolText:AlphabetGlowing = new AlphabetGlowing(0, 0, text, true, false);
		coolText.screenCenter(X);
		coolText.alpha = 1;
		coolText.y += (textGroup.length * 68) + 200;
	...
	override function beatHit()
	{
		...
		if (curBeat % 1 == 0 && !skippedIntro){
			FlxG.camera.zoom = 2;
			FlxTween.tween(FlxG.camera, {zoom: 1}, 0.12);
		}
